...
class PlayMenu(CTk):
    def __init__(self):
        ...
        self.create_lobby_button_image = Image.open(create_lobby_button_image)
        self.create_lobby_button_image = CTkImage(self.create_lobby_button_image, size=(200, 140))
        self.join_lobby_button_image = Image.open(join_lobby_button_image)
        ...
        # Background
        self.bg_image = Image.open(play_menu_image_bg)
